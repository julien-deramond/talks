import{d as _,ak as u,A as h,o as n,b as l,e as t,x as s,C as c,F as f,ag as g,aa as v,l as x,g as b}from"../modules/vue-BOoaS5mz.js";import{a as k,u as y,x as m}from"../index-CYtqDCZH.js";import{_ as N}from"./NoteDisplay.vue_vue_type_style_index_0_lang-BP_shshM.js";import"../modules/shiki-CqyJGmhe.js";const w={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},C={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},A={key:0,class:"border-main mb-8"},z=_({__name:"print",setup(D){const{slides:d,total:p}=k();u(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
